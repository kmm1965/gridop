...
struct cyclic_index_operator : math_operator<MO>
{
    ...
    typedef get_value_type_t<cyclic_index> cyclic_index_value_type;
...
protected:
    constexpr cyclic_index_operator_x(typename super::index_type const& index) : super(index) {}
};
...
protected:
    constexpr cyclic_index_operator_y(typename super::index_type const& index) : super(index) {}
};
