...
protected:
    constexpr first_derivative_operator_x(typename super::index_type const& index) : super(index){}
};
...
protected:
    constexpr first_derivative_operator_y(typename super::index_type const& index) : super(index) {}
};
...
protected:
    constexpr forward_first_derivative_operator_x(typename super::index_type const& index, const length_type &h) : super(index), h(h){}

	template<typename EOP>
    __DEVICE
    constexpr typename super::template get_value_type<get_value_type_t<EOP> >::type operator()(size_t i_, const EOP &eobj_proxy) const
    {
...
protected:
    constexpr backward_first_derivative_operator_x(typename super::index_type const& index, const length_type &h) : super(index), h(h){}
...
protected:
    constexpr central_first_derivative_operator_x(typename super::index_type const& index, const length_type &h) : super(index), h2(h * 2.){}
...
struct first_derivative_operator_x<tag_main> : forward_first_derivative_operator_x<first_derivative_operator_x<tag_main> >
{
    ...
    constexpr first_derivative_operator_x(typename super::index_type const& index, const length_type &h) : super(index, h) {};
...
protected:
    constexpr forward_first_derivative_operator_y(typename super::index_type const& index, const length_type &h) : super(index), h(h) {}
...
protected:
    constexpr backward_first_derivative_operator_y(typename super::index_type const& index, const length_type &h) : super(index), h(h) {}
...
protected:
    constexpr central_first_derivative_operator_y(const length_type &h) : h2(h * 2.) {}
...
struct first_derivative_operator_y<tag_main> : forward_first_derivative_operator_y<first_derivative_operator_y<tag_main> >
{
    ...
    constexpr first_derivative_operator_y(typename super::index_type const& index, const length_type &h) : super(index, h) {};
